...
The value of $c$ is deduced from $\delta$ and $dt$ to validate the CFL as follows:
\begin{equation}
...
By construction of the grid $Z$, $M$ has its bow oriented on the positive side of the $z$ axis, and its starboard on the positive side of the $x$ axis.
