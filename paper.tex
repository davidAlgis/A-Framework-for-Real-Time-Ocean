...
As mention in Section~3.3.2 of Hulin \etal (2001) \cite{hulinHydrodynamiquePhysique2001}, a fluid can be considered incompressible if $u<<c_{sound}$ where $c_{sound}$ if the sound speed in ocean which is approximately equal to $c_{sound} = 1530~m.s^{-1}$\footnote{see \url{https://en.wikipedia.org/wiki/Sound_speed_profile}.}.
