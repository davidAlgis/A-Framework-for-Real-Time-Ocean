...
\begin{enumerate}
	\item If $T_x M \subset T_x H$, then $df_x$ is not the zero map, which corresponds to the intersection being a single point or a segment.
